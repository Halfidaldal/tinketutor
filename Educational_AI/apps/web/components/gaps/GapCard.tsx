...
const EVIDENCE_LABELS: Record<string, string> = {
  canvas_empty: 'Unfilled canvas node',
  quiz_failure: 'Incorrect quiz attempt',
  low_coverage: 'No interaction with source chunk',
};
  ...
  return (
    <div className="surface" style={{ padding: '1.1rem 1.2rem', display: 'grid', gap: '0.85rem' }}>
      ...
      <div style={{ fontSize: '0.75rem', color: 'var(--color-text-tertiary)', lineHeight: 1.6 }}>
        {finding.source_ids.length} source{finding.source_ids.length === 1 ? '' : 's'} cover this topic.
      </div>
